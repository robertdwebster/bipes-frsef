...
Blockly.Python['frsef_grove_board_init'] = function(block) {	
	...
	groveLibraryFunctionString+='        buzzer_dict[connectorName] = Pin(grove_connector_lookup_pin1(connectorName), Pin.OUT)\n'
	groveLibraryFunctionString+='    return buzzer_dict[connectorName].value(state)\n'
	groveLibraryFunctionString+='\n'
