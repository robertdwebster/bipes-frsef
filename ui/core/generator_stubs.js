...
// frsef_grove_board_init - Block is used to declare any functions that need to be used by the other blocks 
Blockly.Python['frsef_grove_board_init'] = function(block) {	
	// Lookup function for Pin 1 of Grove connector to pin on Pi Pico 
	var groveLibraryFunctionString = '#Code automatically generated by BIPES (http://www.bipes.net.br)\n'
	groveLibraryFunctionString+='from machine import Pin\n'
	groveLibraryFunctionString+="from machine import PWM # don't forget this\n"
	groveLibraryFunctionString+="from machine import ADC # don't forget this\n"
	groveLibraryFunctionString+='import time\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='#frsef_grove_board_init:\n'
	groveLibraryFunctionString+='def grove_connector_lookup_pin1(x):\n'
	groveLibraryFunctionString+="\t\treturn {'UART0': 1,'UART1': 5,'D16': 16,'D18': 18,'D20': 20,'I2C0': 9,'I2C1': 7,'A0': 26,'A1': 27,'A2': 28,}[x]\n"
	groveLibraryFunctionString+='def grove_connector_lookup_pin2(x):\n'
	groveLibraryFunctionString+="\t\treturn {'UART0': 0,'UART1': 4,'D16': 17,'D18': 19,'D20': 21,'I2C0': 8,'I2C1': 6,'A0': 26,'A1': 26,'A2': 27,}[x]\n"
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='# --- BUZZER ---\n'
	groveLibraryFunctionString+='buzzer_dict = {}\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='def buzzer_set(connectorName, state):\n'
	groveLibraryFunctionString+='    if connectorName not in buzzer_dict:\n'
	groveLibraryFunctionString+='        pinNumber = grove_connector_lookup_pin1(connectorName)\n'
	groveLibraryFunctionString+='        buzzer_dict[connectorName] = PWM(Pin(pinNumber))\n'
	groveLibraryFunctionString+='        buzzer_dict[connectorName].freq(888)\n'
	groveLibraryFunctionString+='    if state == 1:\n'
	groveLibraryFunctionString+='        return buzzer_dict[connectorName].duty_u16(95)\n'
	groveLibraryFunctionString+='    else:\n'
	groveLibraryFunctionString+='        return buzzer_dict[connectorName].duty_u16(0)\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='# --- LED BUTTON ---\n'
	groveLibraryFunctionString+='class LEDButton:\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def __init__(self, connectorName: str):\n'
	groveLibraryFunctionString+='        self.LED = Pin(grove_connector_lookup_pin1(connectorName), Pin.OUT)\n'
	groveLibraryFunctionString+='        self.Button = Pin(grove_connector_lookup_pin2(connectorName), Pin.IN)\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    # def LED_out(self, x):\n'
	groveLibraryFunctionString+='    #     self.LED.value(x)\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    # def button_in(self):\n'
	groveLibraryFunctionString+='    #     return not self.Button.value()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='LED_button_dict = {}\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='def led_button_get(connectorName) -> LEDButton:\n'
	groveLibraryFunctionString+='    if connectorName not in LED_button_dict:\n'
	groveLibraryFunctionString+='        LED_button_dict[connectorName] = LEDButton(connectorName)\n'
	groveLibraryFunctionString+='    return not LED_button_dict[connectorName].Button.value()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='def led_button_set(connectorName, state):\n'
	groveLibraryFunctionString+='    if connectorName not in LED_button_dict:\n'
	groveLibraryFunctionString+='        LED_button_dict[connectorName] = LEDButton(connectorName)\n'
	groveLibraryFunctionString+='    return LED_button_dict[connectorName].LED.value(state)\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='# --- Mini PIR Motion Sensor ---\n'
	groveLibraryFunctionString+='motion_sensor_dict = {}\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='def motion_sensor_get(connectorName):\n'
	groveLibraryFunctionString+='    if connectorName not in motion_sensor_dict:\n'
	groveLibraryFunctionString+='        pinNumber = grove_connector_lookup_pin1(connectorName)\n'
	groveLibraryFunctionString+='        motion_sensor_dict[connectorName] = Pin(pinNumber, Pin.IN)\n'
	groveLibraryFunctionString+='    return motion_sensor_dict[connectorName].value()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='# --- Analog Sensors: Loudness, Light, etc. ---\n'
	groveLibraryFunctionString+='analog_in_dict = {}\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='def analog_sensor_get(connectorName):\n'
	groveLibraryFunctionString+='    if connectorName not in analog_in_dict:\n'
	groveLibraryFunctionString+='        pinNumber = grove_connector_lookup_pin1(connectorName)\n'
	groveLibraryFunctionString+='        analog_in_dict[connectorName] = ADC(pinNumber)\n'
	groveLibraryFunctionString+='    return analog_in_dict[connectorName].read_u16()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='# --- Ultrasonic Ranger ---\n'
	groveLibraryFunctionString+='class Ultrasonic:\n'
	groveLibraryFunctionString+='    \n'
	groveLibraryFunctionString+='    # Constructor - it has a pin number (an int)\n'
	groveLibraryFunctionString+='    def __init__(self, connectorName: str):\n'
	groveLibraryFunctionString+='        self.pinNumber = grove_connector_lookup_pin1(connectorName)\n'
	groveLibraryFunctionString+='        self.timeout = 100000\n'
	groveLibraryFunctionString+='    \n'
	groveLibraryFunctionString+='    def duration(self, timeout):\n'
	groveLibraryFunctionString+='        # Create a machine.Pin\n'
	groveLibraryFunctionString+='        pin = Pin(self.pinNumber, Pin.OUT)\n'
	groveLibraryFunctionString+='        pin.off()\n'
	groveLibraryFunctionString+='        time.sleep_us(2)\n'
	groveLibraryFunctionString+='        pin.on()\n'
	groveLibraryFunctionString+='        time.sleep_us(5)\n'
	groveLibraryFunctionString+='        pin.off()\n'
	groveLibraryFunctionString+='        pin = Pin(self.pinNumber, Pin.IN)\n'
	groveLibraryFunctionString+='        duration = Ultrasonic.pulseIn(pin, 1, timeout)\n'
	groveLibraryFunctionString+='        return duration\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    # Use ticks_diff(end, begin) where the parameters are microsecond tick variables returned by ticks_us()\n'
	groveLibraryFunctionString+='    @staticmethod\n'
	groveLibraryFunctionString+='    def pulseIn(pin, state, timeout):\n'
	groveLibraryFunctionString+='        begin = time.ticks_us()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='        # wait for any previous pulse to end\n'
	groveLibraryFunctionString+='        while pin.value() == 1: \n'
	groveLibraryFunctionString+='            if (time.ticks_diff(time.ticks_us(), begin)) >= timeout:\n'
	groveLibraryFunctionString+='                return 0\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='        # wait for the pulse to start\n'
	groveLibraryFunctionString+='        while pin.value() == 0: \n'
	groveLibraryFunctionString+='            if (time.ticks_diff(time.ticks_us(), begin)) >= timeout:\n'
	groveLibraryFunctionString+='                return 0\n'
	groveLibraryFunctionString+='        pulseBegin = time.ticks_us()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='        # wait for the pulse to stop\n'
	groveLibraryFunctionString+='        while pin.value() == 1:\n'
	groveLibraryFunctionString+='            if (time.ticks_diff(time.ticks_us(), begin)) >= timeout:\n'
	groveLibraryFunctionString+='                return 0\n'
	groveLibraryFunctionString+='        pulseEnd = time.ticks_us()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='        return time.ticks_diff(pulseEnd, pulseBegin)\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def MeasureInCentimeters(self):\n'
	groveLibraryFunctionString+='        RangeInCentimeters = self.duration(self.timeout) / 29 / 2\n'
	groveLibraryFunctionString+='        return RangeInCentimeters\n'
	groveLibraryFunctionString+='    \n'
	groveLibraryFunctionString+='    def MeasureInMillimeters(self):\n'
	groveLibraryFunctionString+='        RangeInMillimeters = self.duration(self.timeout) * (10 / 2) / 29\n'
	groveLibraryFunctionString+='        return RangeInMillimeters\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def MeasureInInches(self):\n'
	groveLibraryFunctionString+='        RangeInInches = self.duration(self.timeout) / 74 / 2\n'
	groveLibraryFunctionString+='        return RangeInInches\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='ultrasonic_dict = {}\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='def ultrasonic_get(connectorName) -> Ultrasonic:\n'
	groveLibraryFunctionString+='    if connectorName not in ultrasonic_dict:\n'
	groveLibraryFunctionString+='        ultrasonic_dict[connectorName] = Ultrasonic(connectorName)\n'
	groveLibraryFunctionString+='    return ultrasonic_dict[connectorName].MeasureInCentimeters()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='# --- Chained LED ---\n'
	groveLibraryFunctionString+='class P9813:\n'
	groveLibraryFunctionString+='    def __init__(self, num_leds, auto_write=True):\n'
	groveLibraryFunctionString+='        self._num = num_leds\n'
	groveLibraryFunctionString+='        self.auto_write = auto_write\n'
	groveLibraryFunctionString+='        self.reset()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def __setitem__(self, index, val):\n'
	groveLibraryFunctionString+='        # (r, g, b) = val\n'
	groveLibraryFunctionString+='        if isinstance(index, slice):\n'
	groveLibraryFunctionString+='            start, stop, step = index.indices(self._num)\n'
	groveLibraryFunctionString+='            length = stop - start\n'
	groveLibraryFunctionString+='            if step != 0:\n'
	groveLibraryFunctionString+='                length = (length + step - 1) // step\n'
	groveLibraryFunctionString+='            if len(val) != length:\n'
	groveLibraryFunctionString+='                raise ValueError("Slice and input sequence size do not match.")\n'
	groveLibraryFunctionString+='            for val_i, idx_i in enumerate(range(start, stop, step)):\n'
	groveLibraryFunctionString+='                self._set_led(idx_i, val[val_i])\n'
	groveLibraryFunctionString+='        else:\n'
	groveLibraryFunctionString+='            self._set_led(index, val)\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='        if self.auto_write:\n'
	groveLibraryFunctionString+='            self.write()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def __getitem__(self, index):\n'
	groveLibraryFunctionString+='        # returns (r, g, b) if index is an int, eg. self[1]\n'
	groveLibraryFunctionString+='        # or [(r, g, b), (r, g, b)] if index is a slice, eg. self[1:2]\n'
	groveLibraryFunctionString+='        if isinstance(index, slice):\n'
	groveLibraryFunctionString+='            out = []\n'
	groveLibraryFunctionString+='            for idx_i in range(*index.indices(self._num)):\n'
	groveLibraryFunctionString+='                out.append(self._get_led(idx_i))\n'
	groveLibraryFunctionString+='            return out\n'
	groveLibraryFunctionString+='        if index < 0:\n'
	groveLibraryFunctionString+='            index += len(self)\n'
	groveLibraryFunctionString+='        if index >= self._num or index < 0:\n'
	groveLibraryFunctionString+='            raise IndexError\n'
	groveLibraryFunctionString+='        return self._get_led(index)\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def __repr__(self):\n'
	groveLibraryFunctionString+='        return "[" + ", ".join([str(x) for x in self]) + "]"\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def __len__(self):\n'
	groveLibraryFunctionString+='        return self._num\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def _set_led(self, index, val):\n'
	groveLibraryFunctionString+='        (r, g, b) = val\n'
	groveLibraryFunctionString+='        # checksum bits (1, 1, blue[7], blue[6], green[7], green[6], red[7], red[6])\n'
	groveLibraryFunctionString+='        self._buf[4 * index] = (\n'
	groveLibraryFunctionString+='            0xC0 | (b & 0xC0) >> 2 | (g & 0xC0) >> 4 | (r & 0xC0) >> 6\n'
	groveLibraryFunctionString+='        )\n'
	groveLibraryFunctionString+='        # blue, green, red\n'
	groveLibraryFunctionString+='        self._buf[4 * index + 1] = b\n'
	groveLibraryFunctionString+='        self._buf[4 * index + 2] = g\n'
	groveLibraryFunctionString+='        self._buf[4 * index + 3] = r\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def _get_led(self, index):\n'
	groveLibraryFunctionString+='        # returns (r, g, b)\n'
	groveLibraryFunctionString+='        return tuple(self._buf[index * 4 + i] for i in range(3, 0, -1))\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def fill(self, color):\n'
	groveLibraryFunctionString+='        temp = self.auto_write\n'
	groveLibraryFunctionString+='        self.auto_write = False\n'
	groveLibraryFunctionString+='        for i in range(self._num):\n'
	groveLibraryFunctionString+='            self[i] = color\n'
	groveLibraryFunctionString+='        self.auto_write = temp\n'
	groveLibraryFunctionString+='        if self.auto_write:\n'
	groveLibraryFunctionString+='            self.write()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def reset(self):\n'
	groveLibraryFunctionString+='        self._buf = bytearray(self._num * 4)\n'
	groveLibraryFunctionString+='        # checksums\n'
	groveLibraryFunctionString+='        for i in range(0, self._num * 4, 4):\n'
	groveLibraryFunctionString+='            self._buf[i] = 0xC0\n'
	groveLibraryFunctionString+='        self.write()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def write(self):\n'
	groveLibraryFunctionString+='        raise NotImplementedError\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='class P9813_BITBANG(P9813):\n'
	groveLibraryFunctionString+='    def __init__(self, pin_clk, pin_data, num_leds, auto_write=True):\n'
	groveLibraryFunctionString+='        self._clk = pin_clk\n'
	groveLibraryFunctionString+='        self._dat = pin_data\n'
	groveLibraryFunctionString+='        self._clk.init(Pin.OUT)\n'
	groveLibraryFunctionString+='        self._dat.init(Pin.OUT)\n'
	groveLibraryFunctionString+='        super().__init__(num_leds, auto_write)\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def write(self):\n'
	groveLibraryFunctionString+='        # Begin data frame 4 bytes\n'
	groveLibraryFunctionString+='        self._frame()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='        # Send 4 bytes for each LED (checksum, blue, green, red)\n'
	groveLibraryFunctionString+='        for i in range(self._num):\n'
	groveLibraryFunctionString+='            # Send checksum\n'
	groveLibraryFunctionString+='            self._write_byte(self._buf[4 * i])\n'
	groveLibraryFunctionString+='            # Send the 3 colours\n'
	groveLibraryFunctionString+='            self._write_byte(self._buf[4 * i + 1])  # blue\n'
	groveLibraryFunctionString+='            self._write_byte(self._buf[4 * i + 2])  # green\n'
	groveLibraryFunctionString+='            self._write_byte(self._buf[4 * i + 3])  # red\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='        # End data frame 4 bytes\n'
	groveLibraryFunctionString+='        self._frame()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def _frame(self):\n'
	groveLibraryFunctionString+='        # Send 32x zeros\n'
	groveLibraryFunctionString+='        self._dat(0)\n'
	groveLibraryFunctionString+='        for _ in range(32):\n'
	groveLibraryFunctionString+='            self._clk_pulse()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def _clk_pulse(self):\n'
	groveLibraryFunctionString+='        self._clk(0)\n'
	groveLibraryFunctionString+='        self._clk(1)\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='    def _write_byte(self, b):\n'
	groveLibraryFunctionString+='        if b == 0:\n'
	groveLibraryFunctionString+='            # Fast send 8x zeros\n'
	groveLibraryFunctionString+='            self._dat(0)\n'
	groveLibraryFunctionString+='            for _ in range(8):\n'
	groveLibraryFunctionString+='                self._clk_pulse()\n'
	groveLibraryFunctionString+='        else:\n'
	groveLibraryFunctionString+='            # Send each bit, MSB first\n'
	groveLibraryFunctionString+='            for i in range(8):\n'
	groveLibraryFunctionString+='                if (b & 0x80) != 0:\n'
	groveLibraryFunctionString+='                    self._dat(1)\n'
	groveLibraryFunctionString+='                else:\n'
	groveLibraryFunctionString+='                    self._dat(0)\n'
	groveLibraryFunctionString+='                self._clk_pulse()\n'
	groveLibraryFunctionString+='\n'
	groveLibraryFunctionString+='                # On to the next bit\n'
	groveLibraryFunctionString+='                b <<= 1\n'
	groveLibraryFunctionString+='\n'
